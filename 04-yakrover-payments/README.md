...
This protocol will define how robots transact autonomously — receiving payments for services (x402), authenticating paid API calls with wallet-signed HTTP requests (ERC-8128), making micropayments for resources, and managing fleet treasury operations — all governed by the 2-of-3 collaborative security model.
...
- **ERC-8128 wallet auth:** After payment, clients authenticate each HTTP request with Ethereum wallet signatures, using request binding and replay protection instead of API keys or cookies.
